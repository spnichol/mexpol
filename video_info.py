# -*- coding: utf-8 -*-
"""
Created on Sat Mar 18 16:52:25 2017
...
def get_video_localization(youtube, video_id, language):
  ...
  print ("Video title is '%s' and description is '%s' in language '%s'"
         % (localized["title"].encode('utf-8'), localized["description"].encode('utf-8'), language))
...
def list_video_localizations(youtube, video_id):
  ...
  for language, localization in localizations.iteritems():
    print ("Video title is '%s' and description is '%s' in language '%s'"
           % (localization["title"].encode('utf-8'), localization["description"].encode('utf-8'), language.encode('utf-8')))
